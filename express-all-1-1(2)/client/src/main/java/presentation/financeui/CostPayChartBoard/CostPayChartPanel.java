...
public class CostPayChartPanel extends JPanel implements ActionListener{
	...
	public CostPayChartPanel(){
		
		this.setForeground(Color.WHITE);
		this.setBackground(Color.WHITE);
		this.setBounds(0, 0, 684, 964);
		this.setLayout(null);
		...
		JScrollPane p = new JScrollPane(rID);
		p.setBounds(312, 40, 166, 80);
		panel_2.add(p);
		
		save = new JButton("\u4FDD\u5B58");
		save.setBounds(358, 900, 93, 36);
		this.add(save);
		
		cancel = new JButton("\u53D6\u6D88");
		cancel.setBounds(498, 900, 93, 36);
		this.add(cancel);
		...
		Lpmonth.setBounds(380, 90, 85, 28);
		panel_1.add(Lpmonth);
		...
		panel_3.setBorder(new BevelBorder(BevelBorder.RAISED, new Color(128, 128, 128), null, null, null));
		panel_3.setBackground(Color.WHITE);
		panel_3.setBounds(35, 740, 614, 135);
		this.add(panel_3);
		
		totalout = new JTextField();
		totalout.setColumns(10);
		totalout.setBounds(140, 50, 166, 28);
		panel_3.add(totalout);
		
		profit = new JTextField();
		profit.setColumns(10);
		profit.setBounds(140, 90, 166, 28);
		panel_3.add(profit);
		...
		Ltotalin.setBounds(43, 10, 85, 28);
		panel_3.add(Ltotalin);
		
		totalin = new JTextField();
		totalin.setColumns(10);
		totalin.setBounds(140, 10, 166, 28);
		panel_3.add(totalin);
		...
		Ltotalout.setBounds(43, 52, 85, 28);
		panel_3.add(Ltotalout);
