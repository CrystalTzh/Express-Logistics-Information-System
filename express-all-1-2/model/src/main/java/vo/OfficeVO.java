...
public class OfficeVO implements Serializable{
	 ...
	 * @param district
	 */
	public OfficeVO(City city, BeiJingDistrict district) {
		this.city = city;
	 ...
	 * @param district
	 */
	public OfficeVO(City city, ShangHaiDistrict district) {
		this.city = city;
	 ...
	 * @param district
	 */
	public OfficeVO(City city, GuangZhouDistrict district) {
		this.city = city;
		beiJingDistrict = null;
		shangHaiDistrict = null;
	 ...
	 * @param district
	 */
	public OfficeVO(City city, NanJingDistrict district) {
		this.city = city;
		beiJingDistrict = null;
		shangHaiDistrict = null;
		guangZhouDistrict = null;
