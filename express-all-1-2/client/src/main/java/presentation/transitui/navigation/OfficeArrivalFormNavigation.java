...
public class OfficeArrivalFormNavigation extends JPanel implements ActionListener{
	...
	private ArrayList<OfficeArrivalFormPO> allofficearrivalform;
...
//		});
		...
		jlcurrentID.setFont(new Font("当前身份：营业厅业务员   "+UserID.userid+" 当前任务：到达单",Font.PLAIN,15));
...
//        table.setEnabled(false);
        ...
        allofficearrivalform = officeArrivalFormController.findAll();
        if(allofficearrivalform == null){
        	System.out.println("营业厅到达单信息为空！");
        }else {
        	for(int i = 0;i<allofficearrivalform.size();i++){
            	row = new Vector<String>();
            	
            	String NO = allofficearrivalform.get(i).getNO();
            	String date = allofficearrivalform.get(i).getArriveDate();
	...
	public static void setJbReceipt(JButton jbReceipt) {
		OfficeArrivalFormNavigation.jbReceipt = jbReceipt;
	}
	...
	public static void setJbDelivery(JButton jbDelivery) {
		OfficeArrivalFormNavigation.jbDelivery = jbDelivery;
	}
	...
	public static void setJbArrival(JButton jbArrival) {
		OfficeArrivalFormNavigation.jbArrival = jbArrival;
	}
	...
	public static void setJbCarInput(JButton jbCarInput) {
		OfficeArrivalFormNavigation.jbCarInput = jbCarInput;
	}
	...
	public static void setJbDriverInfo(JButton jbDriverInfo) {
		OfficeArrivalFormNavigation.jbDriverInfo = jbDriverInfo;
	}
	...
	public static void setJbCarInfo(JButton jbCarInfo) {
		OfficeArrivalFormNavigation.jbCarInfo = jbCarInfo;
	}
