...
public class DateChooser extends JPanel {
	...
	public int getdatechooserwidth() {
		return width;
	}

	public int getdatechooserheight() {
		return height;
	}
	...
	private void init() throws Exception {
		...
		this.add(dateField, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(0, 0, 150, 0), this.length, 0));
		this.add(btnChoose, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(0, 0, 150, 0), 0, 0));
	}
	...
	class DatePanel extends JPanel implements MouseListener, ChangeListener {
		...
		public void mouseClicked(MouseEvent e) {
			if (e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 1) {
				...
				DateChooser.this.setText(year + "/" + month + "/" + value);
				// simpleDateFormat.format(year+month+value)
				f.dispose();
			}
		}
