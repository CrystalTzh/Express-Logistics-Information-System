...
import presentation.inventoryui.boards.StorageCheckBoard;
import presentation.mainui.MainFrame;
import presentation.userui.modifypasswordui.ModifyPasswordBoard;

public class StorageCheckNavigation extends JPanel implements ActionListener{
...
//				}
		...
		jlcurrentID = new JLabel("当前身份：仓库管理员   "+UserID.userid+" 当前任务：库存查看");
...
//        sp.add(jpanel3);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == jbstart){
			new StorageCheckBoard().setVisible(true);
		}
	}
	...
	public static void setJbStorageInForm(JButton jbStorageInForm) {
		StorageCheckNavigation.jbStorageInForm = jbStorageInForm;
	}
	...
	public static void setJbStorageOutForm(JButton jbStorageOutForm) {
		StorageCheckNavigation.jbStorageOutForm = jbStorageOutForm;
	}
	...
	public static void setJbZone(JButton jbZone) {
		StorageCheckNavigation.jbZone = jbZone;
	}
	...
	public static void setJbStorageCheck(JButton jbStorageCheck) {
		StorageCheckNavigation.jbStorageCheck = jbStorageCheck;
	}
	...
	public static void setJbStorageCounting(JButton jbStorageCounting) {
		StorageCheckNavigation.jbStorageCounting = jbStorageCounting;
	}
	...
	public static void setJbSetLimit(JButton jbSetLimit) {
		StorageCheckNavigation.jbSetLimit = jbSetLimit;
	}
