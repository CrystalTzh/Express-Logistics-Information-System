...
public class ReceiptFormNavigation extends JPanel {
	...
	public ReceiptFormNavigation(){
		...
		jlcurrentID = new JLabel("当前身份：营业厅业务员      当前任务： 收款单");
		jlcurrentID.setFont(new Font("当前身份：营业厅业务员       当前任务：收款单",Font.PLAIN,15));
		...
		String[] columnNames = { "收款单编号", "收款日期","收款金额","收款快递员" };  
