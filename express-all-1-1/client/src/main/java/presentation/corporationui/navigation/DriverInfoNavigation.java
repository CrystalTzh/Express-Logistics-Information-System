...
//	private CardLayout card;
	...
	public DriverInfoNavigation(){
		...
		jlcurrentID = new JLabel("当前身份：营业厅业务员      当前任务： 维护司机信息");
		jlcurrentID.setFont(new Font("当前身份：营业厅业务员      当前任务： 维护司机信息",Font.PLAIN,15));
		...
		String[] columnNames = { "姓名", "司机编号","性别","身份证号","手机","行驶证期限" };  
