...
public class AdfinanceManPanel extends JPanel implements ActionListener{
	...
	public AdfinanceManPanel(){
		...
		jlcurrentID = new JLabel("当前身份：高级财务人员      ");
		jlcurrentID.setFont(new Font("当前身份：高级财务人员       ",Font.PLAIN,15));
