...
//		ConstInfoClientHelper constinfoclienthelper = new ConstInfoClientHelper();
...
//		StorageOutFormClientHelper storageoutformclienthelper = new StorageOutFormClientHelper();
//		UserInfoClientHelper userinfoclienthelper = new UserInfoClientHelper();
//		
//		AccountInfoClientHelper accountimfoclienthelper = new AccountInfoClientHelper();
//		BeginningAccountClientHelper beginningaccountclienthelper = new BeginningAccountClientHelper();
//		CostPayChartClientHelper coustpaychartclienthelper = new CostPayChartClientHelper();
//		PaymentFormClientHelper paymentformclienthelper = new PaymentFormClientHelper();
//		ProfitChartClientHelper porfitchartclienthelper = new ProfitChartClientHelper();
//		ReceiptFormClientHelper receiptformclienthelper = new ReceiptFormClientHelper();
//		
//		
//		
//		CarInputFormClientHelper clienthelper = new CarInputFormClientHelper();
////		clienthelper.goPrint();
//		long NO = 1000000001; //装车单编号
//		String destination = "南京栖霞"; //目的地
//		String motorNumber = "汽运01"; //汽运编号
//		String carNumber = "车辆01"; //车辆代号
//		String loadingMember = "监装01"; //监装员
//		String supercargo = "押运01"; //押运员
//		String putOnCarDate = "2015-11-22"; //装车日期
//		ArrayList<Long> allIDs = new ArrayList<Long>(); //本次装车所有订单号
//		allIDs.add((long) 1000000001);
//		double transCharge = 200; //运费
//		CarInputFormPO po = new CarInputFormPO( NO, destination, motorNumber,
//			carNumber, loadingMember, supercargo, putOnCarDate, allIDs, transCharge);
//		if(clienthelper.goInsert(po)) {
//		System.out.println("插入CarInputFormPO对象完成！！");
//		}
//	}
