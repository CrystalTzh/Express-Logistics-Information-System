...
public class StorageInFormClientServiceImpl extends UnicastRemoteObject implements StorageInFormInventorydataService {
	...
	public StorageInFormClientServiceImpl() throws RemoteException {
		super();
