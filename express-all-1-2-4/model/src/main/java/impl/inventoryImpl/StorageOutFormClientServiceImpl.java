...
public class StorageOutFormClientServiceImpl extends UnicastRemoteObject implements StorageOutFromInventorydataService {
	...
	public StorageOutFormClientServiceImpl() throws RemoteException {
		super();
