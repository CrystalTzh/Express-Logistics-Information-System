...
import impl.inventoryImpl.StorageInFormClientServiceImpl;
...
public class StorageInForm implements StorageInFormInventoryblService {
	...
	public StorageInFormVO StorageInFormfind(String number) throws RemoteException, IllegalArgumentException{
		...
		StorageInFormInventorydataService storageInFormInventorydataService = new StorageInFormClientServiceImpl();
	...
	public boolean StorageInFormsave(StorageInFormVO vo) {
		...
		try {
			storageInFormInventorydataService = new StorageInFormClientServiceImpl();
