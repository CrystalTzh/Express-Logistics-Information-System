...
import impl.inventoryImpl.StorageOutFormClientServiceImpl;
...
public class StorageOutForm implements StorageOutFormInventoryblService {
	...
	public StorageOutFormVO StorageOutFormfind(String number) throws RemoteException, IllegalArgumentException{
		...
		StorageOutFromInventorydataService storageOutFormInventorydataService = new StorageOutFormClientServiceImpl();
	...
	public boolean StorageOutFormsave(StorageOutFormVO vo) {
		...
		try {
			storageOutFromInventorydataService = new StorageOutFormClientServiceImpl();
