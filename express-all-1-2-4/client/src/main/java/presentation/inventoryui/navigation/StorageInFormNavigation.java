...
public class StorageInFormNavigation extends JPanel implements ActionListener{
	...
	public StorageInFormNavigation(){
...
//				}
		...
		jlcurrentID = new JLabel("当前身份：仓库管理员  "+UserID.userid+" 当前任务：入库单");
...
//        table.setEnabled(false);
        ...
        if(allstorageinform == null){
        	System.out.println("入库单信息为空！");
        }else {
        	for(int i = 0;i<allstorageinform.size();i++){
            	row = new Vector<String>();
            	
            	String NO = allstorageinform.get(i).getNO();
...
//        sp.add(jpanel3);
	...
	public static void setJbStorageInForm(JButton jbStorageInForm) {
		StorageInFormNavigation.jbStorageInForm = jbStorageInForm;
	}
	...
	public static void setJbStorageOutForm(JButton jbStorageOutForm) {
		StorageInFormNavigation.jbStorageOutForm = jbStorageOutForm;
	}
	...
	public static void setJbZone(JButton jbZone) {
		StorageInFormNavigation.jbZone = jbZone;
	}
	...
	public static void setJbStorageCheck(JButton jbStorageCheck) {
		StorageInFormNavigation.jbStorageCheck = jbStorageCheck;
	}
	...
	public static void setJbStorageCounting(JButton jbStorageCounting) {
		StorageInFormNavigation.jbStorageCounting = jbStorageCounting;
	}
	...
	public static void setJbSetLimit(JButton jbSetLimit) {
		StorageInFormNavigation.jbSetLimit = jbSetLimit;
	}
