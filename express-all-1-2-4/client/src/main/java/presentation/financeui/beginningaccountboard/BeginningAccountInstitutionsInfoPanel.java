...
public class BeginningAccountInstitutionsInfoPanel extends JPanel implements ActionListener{
	...
	public BeginningAccountInstitutionsInfoPanel(){
...
//        columnNames.add("区");
        ...
        for(Iterator<City> itr = transferlist.keySet().iterator(); itr.hasNext();) {
			...
			for(int i = 0; i < list.size(); i++) {
				...
				row.add(0, "中转中心");
				row.add(1, vo.getTransferOfficeID());
				row.add(2, vo.getCity().toString());
...
//				row.add(4, vo.getBeiJingDistrict().toString());
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == jbstop){
			...
			boolean isOfficeNew = beginningAccountController.syncOffice();
			boolean isTransferNew = beginningAccountController.syncTransferOffice();
			if(isOfficeNew&&isTransferNew){
				model.setRowCount(0);
				Hashtable<City, ArrayList<TransferOfficeVO>> transferlist = beginningAccountController.findAllTransferOfficeInfo();
...
//						row.add(4, vo.getBeiJingDistrict().toString());
	...
	public static void setJbCarInfo(JButton jbCarInfo) {
		BeginningAccountInstitutionsInfoPanel.jbCarInfo = jbCarInfo;
	}
	...
	public static void setJbDriverInfo(JButton jbDriverInfo) {
		BeginningAccountInstitutionsInfoPanel.jbDriverInfo = jbDriverInfo;
	}
	...
	public static void setJbAccountID(JButton jbAccountID) {
		BeginningAccountInstitutionsInfoPanel.jbAccountID = jbAccountID;
	}
	...
	public static void setJbID(JButton jbID) {
		BeginningAccountInstitutionsInfoPanel.jbID = jbID;
	}
	...
	public static void setJbInstitutionsManage(JButton jbInstitutionsManage) {
		BeginningAccountInstitutionsInfoPanel.jbInstitutionsManage = jbInstitutionsManage;
	}
	
	public static void main(String[] args) {
		MainFrame main = new MainFrame();
		main.setContentPane(new BeginningAccountInstitutionsInfoPanel());
